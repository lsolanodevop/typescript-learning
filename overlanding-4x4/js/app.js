...
var changeTitles = [document.querySelector("#h1who"), document.querySelector("#h3who"), document.querySelector("#tituloTarjeta1"), document.querySelector("#tituloTarjeta2"), document.querySelector("#tituloTarjeta3"), document.querySelector("#tituloTarjeta4")];
var changeBodys = [document.querySelector("#cuerpoTarjeta1"), document.querySelector("#cuerpoTarjeta2"), document.querySelector("#cuerpoTarjeta3"), document.querySelector("#cuerpoTarjeta4")];
var changeSubBodys = [document.querySelector("#subCuerpoTarjeta1"), document.querySelector("#subCuerpoTarjeta2"), document.querySelector("#subCuerpoTarjeta3"), document.querySelector("#subCuerpoTarjeta4")];
...
function changeToRussian(element) {
...
function changeToSpanish(element) {
